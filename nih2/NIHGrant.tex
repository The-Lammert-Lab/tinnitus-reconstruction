...
% \subsubsection*{C.2.1. Method}

% In this section, we describe compressive sensing,
% including applicability to data collected in the reverse correlation paradigm,
% and demonstrate its effectiveness for improving the efficiency and accuracy
% of estimates of cognitive representations.
