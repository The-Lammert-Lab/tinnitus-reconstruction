...
To generate stimuli, we partition the frequency space $f \in [100,~22,000]$ Hz into 100 mel-spaced frequency bins
so that each bin is perceptually different to a listener.
For each stimulus, we randomly select ${round}(\mathcal{N}(30, \sqrt{0.3}))$ bins
