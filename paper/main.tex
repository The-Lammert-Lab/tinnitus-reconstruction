...
There is a pressing need for characterization methods targeting tinnitus patients who are not served by current procedures \cite{henryTinnitusEpidemiologicPerspective2020,henryMeasurementTinnitus2016,norenaPsychoacousticCharacterizationTinnitus2002}.
...
where $x \in \mathbb{R}^\mathrm{t}$ represents the subject's internal representation of interest (\eg their tinnitus percept).
