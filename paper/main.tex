...
for human, synthetic, and random subjects.
...
Table \ref{tbl:reconstruction} reports summary statistics for the human
subject reconstruction accuracy.
...
\begin{table}[ht]
    \begin{center}	
        ...
        \resizebox{1\columnwidth}{!}{
            \begin{tabular}{l c r r r}	
                \multicolumn{5}{c}{\textsc{Human Subject Reconstruction Accuracy}} \\
                \hhline{=====}
                Tinnitus Type & $r$ {mean} & $r$ {median} & $r$ {st. dev.} & \# $p<0.05$ \\
                \hline
                Buzzing & 0.533 & 0.467 & 0.275 & 4 \\
                Roaring & 0.566 & 0.677 & 0.296 & 4 \\
                Combined & 0.549 & 0.614 & 0.279 & 8 \\
                \hline
                \hhline{=====}
            \end{tabular}
        }
    \end{center}
%\normalsize
    \caption{Reconstruction accuracy across human subjects.
    \hl{not sure what to say here}.
  }
