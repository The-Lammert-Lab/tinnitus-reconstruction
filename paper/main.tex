...
D. Alexandrou is with the Stritch School of Medicine at Loyola University Chicago.
B. Parrell is with the Department of Communication Sciences and Disorders at University of Wisconsin, Madison, WI. D.A. Chari is with the University of Massachusetts Chan Medical School and the Massachusetts Eye and Ear Infirmary.
...
The roaring results vary more than the buzzing results for human subjects. The roaring ground truth spectrum contains significant high-frequency content,
...
Figure \ref{fig:spectra} shows example reconstructions from top human responses (as quantified by reconstruction accuracy) overlaid on the target sound spectra,
