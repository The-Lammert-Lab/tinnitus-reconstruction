...
in a habituation therapy term \textit{sound therapy},
...
are best suited for patients whose tinnitus resembles pure tones (\eg ringing), which may represent about $50\%$ of patients \cite{henryAuditoryTestResult2009,ukaegbeTinnitusItsEffect2017,vajsakovicPrinciplesMethodsPsychoacoustic2021}.
...
Two spectrally complex and complementary target sounds (``buzzing'' and ``roaring'') were downloaded from the American Tinnitus Association \cite{MeasuringTinnitusAmerican2022} and truncated to $500$ ms in duration (Fig. \ref{fig:spectra}).
...
Presentation level (in dB sound pressure level (SPL)) was not recorded.
