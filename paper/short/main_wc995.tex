...
Thus, the ideal subject has precise knowledge of every stimulus and responds according to Eq. \ref{eq:subjresp}. The \textit{random} subject responds $y_i \in \{1,-1\}$ with uniform random probability, thus ignoring the stimulus entirely.
